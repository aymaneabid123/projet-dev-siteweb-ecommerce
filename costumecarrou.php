...
<body>
    ...
    <div class="product" id="product">
        <img src="color2 gris.png" alt="" class="productImg" style="width: 45%;">
        <div class="productDetails">
            <h1 class="productTitle">COSTUME Carroou</h1>
            <h2 class="productPrice">MAD950</h2>
            ...
            <div class="colors">
                <div class="color" style="background-color: rgb(148, 147, 147);"></div>
        ...
        <div class="payment" >
            ...
            <form action="costume.php" method="POST">
                                <h1 class="payTitle">Personal Information</h1>
                                <label>Name and Surname</label>
                                <input type="text" name="nom_utilisateur" placeholder=" $_SESSION['nom_utilisateur']" class="payInput" >
                                <label>choix de couleur</label>  <select name="produit">
			                            <option >costume math gris</option>
			                          <option >costume math noir</option>
			                          <option >costume math blue</option> 
                                    </select>
    ...
    <footer style="border: 1px solid black;">
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu" id="footerRightMenu">
                ...
                <script src="./costumecarrou.js"></script>       
