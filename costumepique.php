...
<body>
    ...
    <div class="product" id="product">
        <img src="WhatsApp_Image_2023-12-09_at_22.48.44-removebg-preview.png" alt="" class="productImg" style="width: 30%;">
        <div class="productDetails">
            <h1 class="productTitle">COSTUME Pique</h1>
    ...
    <footer style="border: 1px solid black;">
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu" id="footerRightMenu">
                ...
                <script src="./costumemath.js"></script>       
