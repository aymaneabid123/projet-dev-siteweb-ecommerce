...
<body>
    ...
    <div class="product" id="product">
        <img src="color3 noir.png" alt="" class="productImg">
        <div class="productDetails">
            <h1 class="productTitle">COSTUME RAYE</h1>
            <h2 class="productPrice">MAD750</h2>
            ...
            <div class="colors">
                ...
                <div class="color" style="background-color: rgb(152, 152, 160);"></div>
            </div>
            <div class="sizes">
        ...
        <div class="payment" >
            ...
            <form action="costumerayeproduct.php" method="POST">
                                ...
                                <label>choix de couleur</label>  <select name="produit">
                                 <option >costume raye noir</option>
			                          <option >costume raye blue</option>
			                          <option >costume raye gris</option> 
                                    </select>
                ...
                if(isset($_POST['nom_utilisateur']) and isset($_POST['produit']) and isset($_POST['number']) and isset($_POST['adresse']) and isset($_POST['cardnumber']) and isset($_POST['cardmm']) and isset($_POST['cardyyyy']) and isset($_POST['cardcvv']))
                {
                    ...
                    $donnees = $reponse->fetch();
                        ...
                        {   
                            ...
                            $bdd->exec($sql);
                            echo '<center> produit <strong>'.$_POST['nom_utilisateur'].'</strong> effectué avec succés </center>' ; //alerte('Modification du produit'.$_POST['nom'].' effectué avec succés');
                        }
                     ...
                     if (empty($donnees['produit1'])){
                        ...
                        $bdd->exec($sql);
                        echo '<center>  MR <strong>'.$_POST['nom_utilisateur'].'</strong> le produit est ajouter au Shop carte avec succés </center>' ; //alerte('Modification du produit'.$_POST['nom'].' effectué avec succés');
                    }
                    else  
    ...
    <footer style="border: 1px solid black;">
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu" id="footerRightMenu">
                ...
                <script src="./costumerayeproduct.js"></script>                 
</body>
</html>